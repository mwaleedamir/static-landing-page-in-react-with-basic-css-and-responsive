      ...
      <div className="choose">
        <div className="choose-img">
          <div className="flex-img">
            <img className="img1" src="/assets/bg1.jpg" alt="bg" />
            <div className="flex-choose">
              <h1>Expertices</h1>
              <p>on our field</p>
            </div>
          </div>
          <img className="img2" src="/assets/bg1.jpg" alt="bg1" />
        </div>
          ...
          <div className="choose-para">
            ...
            <div className="para-col">
              ...
              <p>
                ...
                Provident amet esse repellendus, itaque consequuntur enim
                ducimus repellat tenetur aperiam debitis facere voluptatem
                rerum?
              </p>
            </div>
          </div>
