    ...
    <div>
      <div class="services2">
        <div class="services2-left">
          ...
          <h1 class="services2-mainheading">Nutring Talent, Feuling Growth</h1>
          <p class="services2-p">
        ...
        <div class="services2-right">
          <div className="grid2-row">
            ...
            <div className="grid2-col">
              <h1>Recuitments</h1>
              <p>Has fine theri jobs Adipisci dolores,Lorem ipsum dolor sit amet consectetur adipisicing elit </p>
            </div>
          </div>
          <div className="grid2-row">
            <div className="grid2-img">
            ...
            <div className="grid2-col">
              ...
              <p>Error officiis facere ipsam placeat sunt culpa harum quod iure autem?</p>
            </div>
          </div>
          ...
          <div className="grid2-row">
            ...
            <div className="grid2-col">
              ...
              <p>amet ipsa tempora aspernatur eligendi iure error tenetur quis.</p>
            </div>
          </div>
          ...
          <div className="grid2-row">
            ...
            <div className="grid2-col">
              ...
              <p>amet ipsa tempora aspernatur eligendi iure error tenetur quis.s</p>
            </div>
          </div>
        </div>
      </div>
